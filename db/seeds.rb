...
(1..pages_number).to_a.each do |page_number|
  ...
  (0..(movies_results - 1)).to_a.each do |i|
    ...
    poster_path = movie['poster_path'] ? "https://image.tmdb.org/t/p/original/#{movie['poster_path']}" : "https://previews.123rf.com/images/happyvector071/happyvector0711608/happyvector071160800591/62947847-abstract-creative-vector-design-layout-with-text-do-not-exist-.jpg?fj=1"
